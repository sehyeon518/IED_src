...
#define _SERVO_SPEED 3 //or 0.3 // servo speed limit (unit: degree/second) 각속도
#define INTERVAL 100 //or 1000  // servo update interval

// global variables
unsigned long last_sampling_time; // unit: ms
int duty_chg_per_interval; // maximum duty difference per interval 한 주기에 증감 가능한 duty의 최댓값
...
// convert angle speed into duty change per interval.
  duty_chg_per_interval = (_DUTY_MAX - _DUTY_MIN) * (_SERVO_SPEED / 180.0) * (INTERVAL / 1000.0); // duty 시간/주기
